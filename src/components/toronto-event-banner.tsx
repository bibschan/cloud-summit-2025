...
export default function TorontoEventBanner(): React.JSX.Element {
  return (
    <div className="absolute top-[80px] left-0 z-40 flex items-center justify-between shadow-md transition-all duration-300 ease-in-out animate-slide-down bg-brink-pink w-full bg-gradient-to-r from-cyan-600 to-blue-700 py-2 px-4 text-white">
