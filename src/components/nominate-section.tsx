...
export const NominateSection = () => {
    return (
        <section className="w-full bg-primary-900 pt-8 md:py-20 z-20" id="media-lounge">
            <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex flex-col gap-8 mb-8">
                        <h3 className="text-3xl md:text-5xl">Nominate Your Company for the <span className="block text-pale-gold">2025 Canadian Cloud Award</span></h3>
                        <p className="text-sm md:text-lg">{EVENT_CONFIG.sections.nominate.description}</p>
                        <p className="text-sm md:text-lg">{EVENT_CONFIG.sections.nominate.cta}</p>
