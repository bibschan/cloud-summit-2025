...
export default function JustificationLetterPDF({ formData, setFormData }: Props) {
    ...
    const updatePdfPreview = () => {
        const doc = new jsPDF();
        doc.setProperties({
            title: 'Convference Attendance Justification Letter',
        });
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white w-full">
            <section ref={pdfRef} className="w-full rounded-lg border text-card-foreground shadow-sm bg-gray-800 border-gray-700 md:p-8 flex-grow">
