...
export default function ScheduleAndSpeakers() {
  ...
  return (
    <div className="w-full bg-[#0B0F17]">
      {/* Schedule Section */}
            ...
            <div className="grid gap-4 mt-8">
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardContent className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium">Live Music</h4>
                    <p className="text-sm text-muted-foreground">
      ...
      <section className="container mx-auto px-4 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-5">
          {Array.from({ length: speakersNum }).map((_, i) => (
            <Card key={i} className="bg-gray-800 border-gray-700">
              <CardContent className="p-6">
                ...
                <h3 className="font-medium text-lg mb-1">Speaker {i + 1}</h3>
