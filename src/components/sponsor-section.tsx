...
export function SponsorSectionComponent() {
  const sponsors = {
    gold: [
      ...
      { name: "Golden Innovations", logo: "/placeholder.svg?height=100&width=200" },
    ],
    silver: [
      { name: "SilverTech", logo: "/placeholder.svg?height=80&width=160" },
      { name: "Silver Solutions", logo: "/placeholder.svg?height=80&width=160" },
    ...
    bronze: [
      ...
      { name: "Copper Industries", logo: "/placeholder.svg?height=60&width=120" },
    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-8">
          We're grateful for the support of our amazing sponsors who make this conference possible.
        </p>
            ...
            <div key={tier}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {tierSponsors.map((sponsor) => (
                  <Card key={sponsor.name} className="bg-white transition-shadow hover:shadow-md">
                    <CardContent className="p-6 flex items-center justify-center h-full">
                      <Image
                        src={sponsor.logo}
                        alt={`${sponsor.name} logo`}
                        width={tier === 'gold' ? 200 : tier === 'silver' ? 160 : 120}
                        height={tier === 'gold' ? 100 : tier === 'silver' ? 80 : 60}
