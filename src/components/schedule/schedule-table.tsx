          ...
          <table className=" w-auto border-collapse ">
            <thead>
              <tr className="border-b-2 border-primary-900">
                <th className="py-3 px-4 text-left text-pale-gold font-medium w-1/4 border-primary-900 border-r-2">Time</th>
                <th className="py-3 px-4 text-left text-pale-gold font-medium w-3/4">Activities</th>
              </tr>
            </thead>
            <tbody>
              {activityEvents.map((event, index) => (
                <tr
                  ...
                  className={cn(
                    ...
                    index !== activityEvents.length - 1 && "border-b-2 border-primary-900"
                  )}
