...
export const HighlightsSection = () => {
  return (
    <section className=" py-20 bg-gray-900" id="highlights">
      <div className="container mx-auto flex flex-col md:grid grid-cols-6 grid-rows-5 gap-4 p-4" aria-label="Highlights for the 2025 cloud summit">
        ...
        <div className="rounded-2xl bg-lemon-lime p-4 col-span-3 row-span-2 text-black flex flex-col justify-center text-center">
          <h3 className={`font-highlight text-xl md:text-8xl font-semibold`}>$10,000+</h3>
          <p className="font-semibold text-sm md:text-lg">Charity Donation Goal</p>
        </div>
        ...
        <div className="rounded-2xl bg-secondary-600 p-4 col-span-2 row-span-2 text-white flex flex-col justify-center text-center">
          <h3 className={`font-highlight text-xl md:text-8xl font-semibold`}>780+</h3>
          <p className="font-semibold text-sm md:text-lg">In-Person Attendees</p>
        </div>
        <div className="rounded-2xl bg-lilac p-4 col-span-2 row-span-2 flex flex-col justify-center text-center">
          <h3 className={`font-highlight text-xl md:text-8xl font-semibold`}>21+</h3>
          <p className="font-semibold text-sm md:text-lg">Presentations & Workshops</p>
        </div>
        <div className="hidden md:block rounded-2xl col-span-2 row-span-3">
          <Image
