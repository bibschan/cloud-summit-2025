...
export default function JustificationLetter() {
  ...
  return (
    <main className=" py-20 bg-gray-900 text-white pb-6 w-full">
      ...
      <p className="text-center text-gray-400 text-sm px-4 mb-4 md:text-lg md:mb-8 md:max-w-4xl mx-auto">A justification letter is a formal written request for approval to attend a professional conference. The template below allows you to easily fill out the form and save/print it to send to your manager. Just fill out the fields below</p>
